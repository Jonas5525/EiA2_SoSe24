document.addEventListener("DOMContentLoaded", () => {
    ...
    function drawRandomRectangles(): void {
    ...
    function drawHorizontalLine(x: number, y: number): void {
    ...
    function drawVerticalLine(x: number, y: number): void {
        context.strokeStyle = "white";
        context.lineWidth = 5;
        context.beginPath();
        context.moveTo(x, y);
    ...
    function drawDiagonalLine(x1: number, y1: number, x2: number, y2: number): void {
        context.strokeStyle = "white";
        context.lineWidth = 5;
        context.beginPath();
